...
/**
 * @brief Finds event by name
 */
class CFindName : public CFind {

    /**
     * @brief wanted name of the event
     */
    string name;
...
public:
     ...
     */
    virtual unique_ptr<CFind> clone () const override { return make_unique<CFindName>( *this );}
